...
* `node` is recommended to be installed either via `nvm` (https://github.com/creationix/nvm) or the official PPAs
  (see https://gist.github.com/leftclickben/2fe0c9d5e9cb64076880).
